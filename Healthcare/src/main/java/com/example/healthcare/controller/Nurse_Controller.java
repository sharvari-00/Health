...
public class Nurse_Controller {
    ...
    public Nurse_Controller(Nurse_service nurseService, Patient_service patientRegistrationService, Doctor_service doctorService, PrescriptionRepository prescriptionRepository, SymptomsRepository symptomRepository1, DiagnosisRepository diagnosisRepository){this.nurse_service=nurseService;
